...
rdt_sender.N=4 # Window size for the sender
rdt_receiver.N=4 # Window size for the receiver (Note: This is ignored in the GBN protocol, but required in the SR protocol)
...
print(t, rdt_sender.num_retransmissions/rdt_sender.total_packets_sent*100.0, channel_for_data.channel_utilization_time/t*100.0)
